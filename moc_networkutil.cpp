/****************************************************************************
** Meta object code from reading C++ file 'networkutil.h'
**
...
#error "The header file 'networkutil.h' doesn't include <QObject>."
...
void Zeeker::NetworkUtil::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (NetworkUtil::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkUtil::downloadFinish)) {
                *result = 0;
                return;
            }
        }
